...
class ValidationConfig:
    ...
    expected_year: Optional[int] = None # El año se extraerá automáticamente de la primera hoja del Excel (celda A1 de Mapping_Options). Si se establece aquí, se usará este valor como fallback.
